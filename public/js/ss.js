...
//main chat screen
    ...
    $("#msgs").on('click', function() {
        alert("you can remove the message surely");
        $("div").remove(".messages");
    });
...
//});
    ...
    socket.on("update-people", function(data){
        ...
        $.each(data.people, function(a, obj) {
            ...
            $('#people').append("<li class=\"list-group-item\" style='color: deepskyblue'><span>" + obj.name + "</span> <i class=\"fa fa-"+obj.device+"\"></i> "
            + html );
            //peopleOnline.push(obj.name);
        });
    ...
    socket.on("chat", function(person, msg) {
        $("#msgs").append("<div class='messages'><strong><span class='text-success'>" + person.name
    ...
    if (typeof(Storage) !== "undefined") {
        // Store
        localStorage.setItem("palanivel", "#conversation");
        // Retrieve
        document.getElementById("#msgs").innerHTML = localStorage.getItem("palanivel");
    } else {
